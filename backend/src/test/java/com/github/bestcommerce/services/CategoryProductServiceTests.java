...
class CategoryProductServiceTests {
    ...
    void setUp() {
        ...
        existingCategorNameStoreType = "STORE";
    ...
    @Test
    void saveShouldProductReturnCategoryDTO() {
        CategoryDTO result = categoryProductService.insert(categoryDTO);
        Assertions.assertNotNull(result);
    }
    @Test
    void updatedShouldThrowResourceNotFoundExceptionWhenIdDoesNotExist() {
        Assertions.assertThrows(ResourceNotFoundException.class,
                () -> categoryProductService.update(nonExistingId, categoryDTO));
    }
